...
<% request.setCharacterEncoding("utf-8");
    ...
    {
        String visitee1 = request.getParameter("visitee") ;
        String username1 = (String)session.getAttribute("User") ;
        String visiter1 = username1 ;
        String btn_value1 = request.getParameter("btn"); ;

        Class.forName("com.mysql.jdbc.Driver");
        Connection con1=DriverManager.getConnection(connectString,"root", "123456");
        Statement stmt1=con1.createStatement();

        String fmt1="select * from attention where visiter='%s' and visitee='%s' ";
        String sql1=String.format(fmt1,visiter1,visitee1) ;
        ...
        if(btn_value1.equals("关注"))
        {
            String fmt2="insert into attention(visiter,visitee) values('%s','%s')";
            String sql2=String.format(fmt2,visiter1,visitee1);
            int cnt=stmt1.executeUpdate(sql2);
        }
        else
        { 
            String fmt2="delete from attention where visiter='%s' and visitee='%s' ";
            String sql2=String.format(fmt2,visiter1,visitee1);
            int cnt=stmt1.executeUpdate(sql2);
        }
        visitee1 = "'" + visitee1 + "'" ;
...
<body>
    ...
    <div id="main">
        <div id="mainpage">
            <%
                /*从数据库中读取该用户的数据---------------------------------------------------------------*/
                    ...
                    String sql2=String.format(fmt2,visitee) ;
            ...
            <div id="user_top">
                ...
                <form method="post" action=otherhome.jsp?visitee=<%=visitee%> >
                    <input class="btn" type="submit" id="btn" name="btn" value=<%=btn_value%> >
                </form>
            ...
            <%
                ...
                String sql1=String.format(fmt1,visitee) ;
                ...
                /*取关注的人数，被关注的人数，信息数------------------------------------------------------------------*/
                    ...
                    String sql6=String.format(fmt6,visitee) ;
                    ...
                    sql6 = String.format(fmt6,visitee) ;
        ...
        <div id="sidepage">
            <div id="user_stats">
                <a href=""><span class="count"><%=myattention%></span> <span class="label">Ta关注的人</span></a>
                <br>      
                <a href=""><span class="count"><%=myattentioned%></span> <span class="label">关注Ta的人</span></a>
                <br>
